...
const ProductDetail = (props) => {
    ...
    return (
        <div className="p-5 font-kumbh md:p-0">
            <h1 className="uppercase mb-2 text-dark-grayish-blue text-xs font-semibold tracking-widest md:mb-6">sneaker company</h1>
            <h2 className="capitalize mb-5 text-3xl font-bold md:mb-6 md:text-4xl">{data.title}</h2>
            <p className="text-dark-grayish-blue md:mb-6">{data.description}</p>
            ...
            <div className="w-full mt-5 flex flex-col gap-4 md:flex-row">
                <div className="flex justify-between items-center bg-light-grayish-blue p-5 rounded-md md:w-full lg:w-1/3">
                ...
                <Button onClick={()=> handleAddToCart({title:data.title, price:data.price, qty:qty})}>
